  ...
  <div class="row">
    <div class="col-6 p-2">
      ...
      <div class="row g-1 text-center">
        ...
        <div class="col-12">
					<textarea class="form-control" rows="2" cols="50" :value="defaultJob.message" id="singleJobMessage" placeholder="Message"
                    @input="updateSingleJob"/>
        </div>
    ...
    <div class="col-6 p-2">
      ...
      <div class="row g-1 text-center">
        ...
        <div class="col-12">
					<textarea class="form-control" rows="2" cols="50" :value="defaultMultiJob.message" id="multiJobMessage" placeholder="Message"
                    @input="updateMultiJob"/>
        </div>
        <div class="col-8">
          <div class="input-group">
            <input class="form-control" type="number" :value="defaultMultiJob.mps" id="multiJobMps" min="0" placeholder="0" @input="updateMultiJob"/>
        ...
        <div class="col-4">
          <input class="form-control" type="number" :value="defaultMultiJob.count" id="multiJobCount" min="0" placeholder="0" @input="updateMultiJob"/>
        </div>
        <div class="col-12 mt-2">
